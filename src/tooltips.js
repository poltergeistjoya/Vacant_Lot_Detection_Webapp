export const TOOLTIPS = {
  ...
  overlay: 'Pixels predicted as vacant by an open-source image segmentation model trained on NAIP aerial imagery at 0.6 m resolution. Dark areas are non-vacant; clear areas are predicted vacant lots at the current confidence threshold. Roads and athletic surfaces (baseball diamonds, courts, etc.) are excluded.',
