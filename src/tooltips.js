export const TOOLTIPS = {
  ...
  parcels: 'MapPLUTO parcel data (NYC Dept of City Planning). Visible at zoom 14+. A parcel is classified as model-vacant when at least 20% of its land area is predicted vacant. Red = model + PLUTO agree vacant; Orange = model predicts but PLUTO doesn\'t record; Blue = PLUTO records but model missed. Click any lot for ownership details.',
};
