export const TOOLTIPS = {
  ...
  overlay: 'Vacant lot overlay combining model predictions and PLUTO records by default. Use the source selector below to show model only, PLUTO only, or both. Dark areas are non-vacant; clear areas are vacant.',
  ...
  parcels: 'MapPLUTO parcel boundaries and ownership data (NYC Dept of City Planning). Visible at zoom 14+. Colors show vacancy agreement: Red = model + PLUTO agree; Orange = model only; Blue = PLUTO only. Does not affect the raster overlay. Click any lot for details.',
};
